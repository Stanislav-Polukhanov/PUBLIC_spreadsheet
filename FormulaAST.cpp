...
namespace ASTImpl {
    ...
    public:
        ...
        virtual double Evaluate(const std::function<double(Position pos)>& cell_value_getter) const = 0;
    ...
    namespace {
        ...
        public:
            ...
            double Evaluate(const std::function<double(Position pos)>& cell_value_getter) const override {
                switch (type_){
                    case Type::Add : {
                        double temp = lhs_->Evaluate(cell_value_getter) + rhs_->Evaluate(cell_value_getter);
        ...
        public:
            ...
            double Evaluate(const std::function<double(Position pos)>& cell_value_getter) const override {
                return cell_value_getter(*cell_);
            }
...
double FormulaAST::Execute(const std::function<double(Position pos)>& cell_value_getter) const {
